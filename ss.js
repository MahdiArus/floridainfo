...
(function categoryInit(){
  ...
  const titleMap = {
    administrative: ['مخالفات إدارية', 'سلوكيات تنظيمية وانضباطية'],
    field: ['مخالفات ميدانية', 'سلوك أثناء العمل الميداني'],
    behavior: ['مخالفات جسيمة', 'قضايا عسكرية كبرى وسلوكيات خطيرة']
  };
...
(function detailInit(){
  ...
  panel.innerHTML = `
    ...
    <div class="detail-desc">
      ...
      <div class="badge-punishment" style="background:rgba(220,38,38,0.08);color:var(--red);border:1px solid rgba(220,38,38,0.06)">${item.punishment}</div>
    </div>
  `;
